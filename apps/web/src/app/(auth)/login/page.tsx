  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-bg px-6 text-ink">
      ...
      <div className="w-full max-w-[400px]">
        <h1 className="font-serif text-[34px] font-medium tracking-[-0.02em]">Entrar</h1>
        <p className="mt-2.5 text-sm text-muted">
          Seu ciclo está esperando. Retome o foco.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-[10px] border border-border-strong bg-surface px-4 py-3 text-[15px] text-ink outline-none transition focus:border-accent focus:ring-[3px] focus:ring-accent-soft"
            />
          </div>
          <div>
            <label
